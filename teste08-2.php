...
<title>MySQL</title>
<style type="text/css">
body{background-color: #ccc;font-family: Arial;font-size:18px;}
#site{position:relative;display:block;margin:0 auto;width:620px; }
h5{position: relative;display: block;width: 260px;margin: 0 auto;text-align: center;}
h5.cons{width:300px; border:1px solid #bbb;padding:5px; text-align: left;}

#form1 , #form2, #form3{display:block;position:relative;background-color:#ddd;box-shadow:3px 3px 5px black; }
#form1{top:5px; width: 275px;height: 250px;float: left;} 
#form2{top:5px; width: 275px;height: 250px;float: right;}
#form3{top:10px; width: 590px;height: 100%;margin: 0 auto;}

legend{font-weight:bold; text-align: center;}
.campo{display: block;position:relative;width: 250px; margin-bottom:15px; margin: 0 auto;}
#user, #pass{background-color:#fff; width: 170px;}
#botao {display: block;position:relative;width: 120px;margin: 0 auto;}
...
<!-- *************************** ADD USER *********************************** -->
<form method="POST">
<fieldset id="form1"><legend>Cadastrar</legend><br><br>
...
$nuser = $_POST['nuser'];$npass = $_POST['npass'];$npassMD5 = md5($npass);
$sql0 = "SELECT * FROM login WHERE user = '$nuser'";
$result = mysqli_query($conexao,$sql0);
if(mysqli_num_rows($result) > 0 ){print "<h5>Erro => $nuser => JÁ EXISTE ! </h5>";}
else{
...
<!-- *************************** DEL USER *********************************** -->
<form method="POST">
<fieldset id="form2"><legend>Apagar</legend><br><br>
...
else{print "<h5>Usuario Não Encontrado !! </h5>";}}
?>
</fieldset></form>

<!-- *************************** CONSULTA *********************************** -->
<form method="POST">
<fieldset id="form3"><legend>Consultar</legend><br><br>
