...
<fieldset class="index">
    ...
    <ul>
        ...
        <li><a href="./index_aux.php?file=teste12.php" target="_blank">Teste 12 - Sistema MVC Composer</a></li>
        <li><a href="./index_aux.php?file=teste13.php" target="_blank">Teste 13 - Fat Free Framework</a></li>
        <li><a href="./index_aux.php?file=teste14.php" target="_blank">Teste 14 - Laravel 6</a></li>
        <!-- FIM do /index.php -->
