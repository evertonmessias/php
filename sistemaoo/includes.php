...
class Sistema
{
    ...
    public function lista($tabela, $tipo, $conexao)
    {
        ...
        foreach ($lista as $vetor) {
            if ($tipo == "alterar") {
                print "<tr class='select'><td class='tdida'><input type='radio' name='opcao' id='id" . $id . "' value='" . $vetor['id'] . "'/></td><td class='tdida'>" . $vetor['id'] . "</td><td class='tnome" . $vetor['id'] . "'>" . $vetor['nome'] . "</td><td class='ttelefone" . $vetor['id'] . "'>" . $vetor['telefone'] . "</td><td class='temail" . $vetor['id'] . "'>" . $vetor['email'] . "</td></tr>";
            } elseif ($tipo == "apagar") {
                print "<tr class='select'><td class='tdida'><input type='checkbox' id='id" . $id . "' value='" . $vetor['id'] . "'/></td><td class='tdida'>" . $vetor['id'] . "</td><td>" . $vetor['nome'] . "</td><td>" . $vetor['telefone'] . "</td><td>" . $vetor['email'] . "</td></tr>";
            }
            $id++;
            $total++;
        }
